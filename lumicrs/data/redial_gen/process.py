...
if __name__ == '__main__':
    ...
    process('/media/wjz/2TBverydiao/ECR/src_emo/data/redial/valid_data_dbpedia_emo.jsonl', '/media/wjz/2TBverydiao/ECR/src_emo/data/redial/valid_data_processed.jsonl', item_set)
    process('/media/wjz/2TBverydiao/ECR/src_emo/data/redial/test_data_dbpedia_emo.jsonl', '/media/wjz/2TBverydiao/ECR/src_emo/data/redial/test_data_processed.jsonl', item_set)
    process('/media/wjz/2TBverydiao/ECR/src_emo/data/redial/train_data_dbpedia_emo.jsonl', '/media/wjz/2TBverydiao/ECR/src_emo/data/redial/train_data_processed.jsonl', item_set)
