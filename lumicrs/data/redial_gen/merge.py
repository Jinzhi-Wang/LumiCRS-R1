...
for split in ['train', 'valid', 'test']:
    raw_file_path = f"/media/wjz/2TBverydiao/ECR/src_emo/data/redial_gen/{split}_data_processed.jsonl"
    raw_file = open(raw_file_path, encoding='utf-8')
    raw_data = raw_file.readlines()
    # print(len(raw_data))

    gen_file_path = f"/media/wjz/2TBverydiao/ECR/src_emo/data/redial_gen/{gen_file_prefix}_{split}.jsonl"
