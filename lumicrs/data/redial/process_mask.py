...
if __name__ == '__main__':
    with open('/media/wjz/2TBverydiao/ECR/src_emo/data/redial/entity2id.json', 'r', encoding='utf-8') as f:
    ...
    process('/media/wjz/2TBverydiao/ECR/src_emo/data/redial/valid_data_dbpedia_emo.jsonl', '/media/wjz/2TBverydiao/ECR/src_emo/data/redial/valid_data_processed.jsonl', movie_set)
    process('/media/wjz/2TBverydiao/ECR/src_emo/data/redial/test_data_dbpedia_emo.jsonl', '/media/wjz/2TBverydiao/ECR/src_emo/data/redial/test_data_processed.jsonl', movie_set)
    process('/media/wjz/2TBverydiao/ECR/src_emo/data/redial/train_data_dbpedia_emo.jsonl', '/media/wjz/2TBverydiao/ECR/src_emo/data/redial/train_data_processed.jsonl', movie_set, movie_name_set)
